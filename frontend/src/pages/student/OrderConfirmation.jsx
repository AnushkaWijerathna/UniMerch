...
export default function OrderConfirmation() {
 ...
 const { total } = useCart();
  ...
  location.state?.pickupDay || "Friday"
);
...
//TO DO:
//In order confirmation the date is not getting calculated properly. check the logic for that
//Also at club admin dashboard the settings do not load for the correct admin account 
//And also in club admin dashboard the club creation fails; check that as well
//Except for that product adding is not even there
//And the order management is not implemented yet too
